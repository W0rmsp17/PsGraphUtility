...
namespace PsGraphUtility.Graph.Entra.Groups.Models;
...
public sealed class GraphGroupDto
{
    ...
    public string[] GroupTypes { get; init; } = Array.Empty<string>();
    ...
    public string[] ProxyAddresses { get; init; } = Array.Empty<string>();
    public string[] ResourceBehaviorOptions { get; init; } = Array.Empty<string>();
    public string[] ResourceProvisioningOptions { get; init; } = Array.Empty<string>();
